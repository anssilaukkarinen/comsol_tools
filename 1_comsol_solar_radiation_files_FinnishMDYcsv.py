...
The input file is assumed to be one of the
Finnish Moisture Design Years (MDY)
- There are specific column names
- Radiation parameters are mean values of the previous hour, W/m2
- Time is given as the Finnish normal time (winter time), i.e. UTC+2
  throughout the year.
